        ...
        switch (datasourceType) {
            ...
            case hive:
                ...
                if (StringUtils.isNotEmpty(hiveConfiguration.getAuthMethod()) && hiveConfiguration.getAuthMethod().equalsIgnoreCase("kerberos")) {
                    System.setProperty("java.security.krb5.conf", "/BITools/Server/resource/conf/krb5.conf");
                    ...
                    loginUserFromKeytab.invoke(null, hiveConfiguration.getUsername(), "/BITools/Server/resource/conf/" + hiveConfiguration.getPassword());
                } else {
