export default {
  ...
  dataset: {
    ...
    sql_variable_limit_1: '1. SQL variables can only be used in WHERE conditions, MySQL stored procedures, PostgreSQL functions, and SQL Server stored procedures',
    sql_variable_limit_2: '2、SQL Example：select * from table_name where column_name1=\'${param_name1}\' and column_name2 in ${param_name2}',
    sql_variable_limit_3: '3、Example of MySQL stored procedures：CALL sp_financial_analysis_simple(\'${param_name1}\',"${param_name2}")',
    sql_variable_limit_4: '4、PostgreSQL Function Example：SELECT * FROM sp_financial_analysis_simple(\'${param_name1}\',"${param_name2}")',
    sql_variable_limit_5: '5、SQL Server stored procedure example：EXEC sp_financial_analysis_simple \'${param_name1}\',"${param_name2}"',
    ...
    parse_error: 'Failed to parse Excel. Please check the format, fields, and other details. Below are the guidelines for importing Excel files:' +
      '1. Merged cells are not allowed in the file;' +
      '2. The first row must be the header row, which cannot be empty or in date format;' +
      '3. Ensure the Excel file size is under 500M.',
  ...
  datasource: {
    ...
    kerbers_info: 'Please make sure krb5 Conf, KeyTab key, added to path: /BITools/Server/resource/conf',
  ...
  auth: {
    ...
    dataFillingAuthHead: 'All Data Form',
