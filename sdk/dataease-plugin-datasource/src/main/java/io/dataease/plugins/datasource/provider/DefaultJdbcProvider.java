...
public abstract class DefaultJdbcProvider extends Provider {
    ...
    static private final String FILE_PATH = "/BITools/Server/resource/drivers";
    static private final String THIRDPART_PATH = "/BITools/Server/resource/plugins/thirdpart";
    static private final String DEFAULT_PATH = "/BITools/Server/resource/plugins/default";
    static private final String CUSTOM_PATH = "/BITools/Server/resource/custom-drivers/";
